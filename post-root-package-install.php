...
rename('.idea/MistyPlugin.iml', sprintf('.idea/%s.iml', $pluginFullName));
file_replace('.idea/modules.xml', [
    '$PROJECT_DIR$/.idea/MistyPlugin.iml' => sprintf('$PROJECT_DIR$/.idea/%s.iml', $pluginFullName),
]);
